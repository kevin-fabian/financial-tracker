...
class AccountControllerSpringBootTest {
    ...
    class DeleteAccountById {
        ...
        void givenExistingId_thenReturnsNoContent() throws Exception {
            ...
            mockMvc.perform(delete("/api/accounts/" + account.id())
                            .with(jwt()
                                    .authorities(new SimpleGrantedAuthority("USER"))
                                    .jwt(jwt -> jwt
                                            .audience(List.of("financial-tracker-test"))
    ...
    class GetAccounts {
        ...
        @Test
        void givenMultipleAccounts_thenReturnsPagedAccounts() throws Exception {
        ...
        @Test
        void givenNoAccounts_thenReturnsEmptyPage() throws Exception {
            mockMvc.perform(get("/api/accounts?page=0&size=10&sort=name&direction=ASC")
                            .with(jwt()
                                    .authorities(new SimpleGrantedAuthority("USER"))
                                    .jwt(jwt -> jwt
